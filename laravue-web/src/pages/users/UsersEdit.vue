...
import usersUpdateRules from "@/validations/users/users-update.rules";
...
const fetchUser = async () => {
  ...
  try {
    ...
    state.data.email = response.data.data.email;
...
const update = async () => {
  ...
  state.updating = true;
  try {
    await UserService.update(props.id, state.data);
...
<template>
  ...
  <div class="row mb-2">
    <div class="col-12 mb-3">
      <h4 class="fw-semibold mb-8">Editar Usuário</h4>
